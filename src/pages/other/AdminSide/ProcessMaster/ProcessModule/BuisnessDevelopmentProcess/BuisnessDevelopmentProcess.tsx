...
const AccountProcess = () => {
    ...
    const periodFromValidIDs = ['BD.01'];
    const periodToValidIDs = ['BD.01'];
    const intervalTypeValidIDs = ['BD.01', 'BD.02', 'BD.03', 'BD.04', 'BD.05', 'BD.06', 'BD.07'];
    const timeValidIDs = ['BD.01', 'BD.02', 'BD.03', 'BD.04', 'BD.05', 'BD.06', 'BD.07'];
    const shopIDValidIDs = ['BD.02'];
    const shopNameValidIDs = ['BD.02'];
                        ...
                        <Row>
                            ...
                            <Col lg={12}>
                                ...
                                <Row>
                                    ...
                                    {["Weekly"].includes(process.intervalType) && (['BD.01', 'BD.02', 'BD.03', 'BD.04', 'BD.05', 'BD.06', 'BD.07'].includes(process.processID)) && (
                                        <Col lg={6}>
                                            <Form.Group controlId="intervalType" className="mb-3">
                                    ...
                                    {["Monthly"].includes(process.intervalType) && (['BD.01', 'BD.02', 'BD.03', 'BD.04', 'BD.05', 'BD.06', 'BD.07'].includes(process.processID)) && (
                                        <Col lg={6}>
