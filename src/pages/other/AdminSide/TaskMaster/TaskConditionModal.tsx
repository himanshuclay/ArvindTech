                    ...
                    <Col lg={12} className="">
                        <Card.Body>
                            <ul className="list-group">
                                ...
                                {!parseDataForSingle && parseConditionData[0]?.taskSelections && (
                                    <li className="list-group-item">
                                    ...
                                    <li className="list-group-item">
                                        ...
                                        <div className="d-flex flex-wrap mt-2">
                                            <div
                                                ...
                                                style={{ width: "25%", border: "1px solid #ccc", borderRadius: "5px" }}
                                            >
                                                <span><strong>Number:</strong> {parseConditionData[0]?.taskSelections?.taskNumber || "N/A"}</span>
                                                <span><strong>Type:</strong> {parseConditionData[0]?.taskSelections?.taskType || "N/A"}</span>
                                                <span><strong>Timing:</strong> {parseConditionData[0]?.taskSelections?.taskTiming || "N/A"}</span>
                                                {parseConditionData[0]?.taskSelections?.taskTiming === "Day" && (
                                                    <span><strong>Day:</strong> {parseConditionData[0]?.taskSelections?.Day || "N/A"}</span>
                                                )}
                                                {parseConditionData[0]?.taskSelections?.taskTiming === "WeekDay" && (
                                                    <>
                                                        <span><strong>WeekDay:</strong> {parseConditionData[0]?.taskSelections?.WeekDay || "N/A"}</span>
                                                        <span><strong>Time:</strong> {parseConditionData[0]?.taskSelections?.time || "N/A"}</span>
                                                    </>
                                                )}
                                            </div>
                                        </div>
                            ...
                            {parseDataForSingle ?
                                (
                                    <Row className="bg-light m-2 p-2">
                                        <Col lg={4}>
                                            <Form.Group controlId="taskNumber" className="mb-3">
                                                <Form.Label>Select Successor Task For hi</Form.Label>
                                                <Select
                                                    name="taskNumber"
                                                    value={combinedOptions.find((item) => item.task_Number === taskSelections?.taskNumber) || null}
                                        ...
                                        <Col lg={4}>
                                            <Form.Group controlId="taskType" className="mb-3">
                                                ...
                                                <Select
                                                    name="taskType"
                                                    options={optionstaskType}
                                                    value={optionstaskType.find(option => option.value === taskSelections?.taskType)}
                                        ...
                                        <Col lg={4}>
                                            <Form.Group controlId="taskTiming" className="mb-3">
                                                ...
                                                <Select
                                                    name="taskTiming"
                                                    options={optionsTaskTiming}
                                                    value={optionsTaskTiming.find(option => option.value === taskSelections?.taskTiming)}
                                            ...
                                            <Col lg={4}>
                                                <Form.Group controlId="Day" className="mb-3">
                                                    ...
                                                    <Select
                                                        ...
                                                        options={dropdownValuesFlag4}
                                                        value={dropdownValuesFlag4.find(
                                                            (option) => option.name === taskSelections?.Day
                                                        ) || null}
                                        ...
                                        {taskSelections?.taskTiming === "WeekDay" && (
                                            <>
                                                <Col lg={4}>
                                                    <Form.Group controlId="WeekDay" className="mb-3">
                                                        <Form.Label>Date:</Form.Label>
                                                        <Select
                                                            ...
                                                            options={dropdownValuesFlag2}
                                                            value={dropdownValuesFlag2.find(
                                                                (option) => option.name === taskSelections?.WeekDay
                                                            ) || null}
                                                ...
                                                <Col lg={4}>
                                                    <Form.Group controlId="time" className="mb-3">
                                                        ...
                                                        <Select
                                                            ...
                                                            options={dropdownValuesFlag3}
                                                            value={dropdownValuesFlag3.find(
                                                                (option) => option.name === taskSelections?.time
                                                            ) || null}
