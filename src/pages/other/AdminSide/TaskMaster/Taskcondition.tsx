                                                ...
                                                (Array.isArray(parseConditionData[0]?.taskSelections) ? parseConditionData[0]?.taskSelections : [parseConditionData[0]?.taskSelections]).map((task: any, index: number) => (
                                                    ...
                                                    >
                                                        ...
                                                        {task.taskTiming === "Hours" && (
                                                            <span><strong>Hours:</strong> {task.Hours || "N/A"}</span>
                                                        )}
                                                ...
                                                <Col lg={4}>
                                                    <Form.Group controlId="Days" className="mb-3">
                                                        ...
                                                        <Form.Control
                                                            ...
                                                            onChange={(e) => handleChange(index, 'Days', String(e.target.value))}
                                                ...
                                                <Col lg={4}>
                                                    <Form.Group controlId="Days" className="mb-3">
                                                        ...
                                                        <Form.Control
                                                            ...
                                                            onChange={(e) => updateTaskSelection('Days', String(e.target.value))}
                                                            placeholder="Enter Days"
                                                        />
                                                    </Form.Group>
                                                </Col>
                            ...
                            {taskRows.map((taskRow, index) => (
                                <Row key={index} className="bg-light m-2 p-2 ">
                                    ...
                                    {taskRow.taskTiming === "Hours" && (
                                        ...
                                        <>
                                            <Col lg={4}>
                                                <Form.Group controlId={`Hours-${index}`} className="mb-3">
                                                    <Form.Label>Day:</Form.Label>
                                                    <Form.Control
                                                        type="number"
                                                        name="Day"
                                                        value={taskRow.Hours || ''}
                                                        onChange={(e) => handleTaskFieldChange(index, "Hours", String(e.target.value))}
                                                        placeholder="Enter Task Day"
                                                    />
                                                </Form.Group>
                                            </Col>
                                            ...
                                            <Col lg={4}>
                                                <Form.Group controlId="Days" className="mb-3">
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        name="Days"
                                                        value={taskRow.Days || ''}
                                                        onChange={(e) => handleTaskFieldChange(index, 'Days', String(e.target.value))}
                                                        placeholder="Enter Days"
                                                    />
                                                </Form.Group>
                                            </Col>
