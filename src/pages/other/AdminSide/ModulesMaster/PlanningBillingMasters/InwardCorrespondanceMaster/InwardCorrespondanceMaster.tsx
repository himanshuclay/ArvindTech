...
const InwardCorrespondanceMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'correspondenceType', label: 'correspondenceType', visible: true },
        { id: 'uploadedFile', label: 'uploadedFile', visible: true },
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/InwardCorrespondanceMaster/GetInwardCorrespondance/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.inwardCorrespondanceMasters);
                setMesses(response.data.inwardCorrespondanceMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/InwardCorrespondanceMaster/GetInwardCorrespondance`, {
    ...
    useEffect(() => {
        ...
        // fetchData('InwardCorrespondanceMaster/GetInwardCorrespondance', setMessList, 'inwardCorrespondanceMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>InwardCorrespondance Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/InwardCorrespondanceMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add InwardCorrespondance Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/InwardCorrespondanceMasterAddEdit/${item.id}`}>
...
export default InwardCorrespondanceMaster;