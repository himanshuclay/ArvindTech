...
const BTSPaymentMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'paymentRequestedFor', label: 'Payment Requested For', visible: true },
        { id: 'receiptType', label: 'Receipt Type', visible: true },
        { id: 'no', label: 'No', visible: true },
        { id: 'amount', label: 'Amount', visible: true },
        { id: 'date', label: 'Date', visible: true },
        { id: 'paymentDueDate', label: 'Payment Due Date', visible: true },
        { id: 'gstHoldAmount', label: 'GST Hold Amount', visible: true },
        { id: 'retentionHoldAmount', label: 'Retention Hold Amount', visible: true },
        { id: 'royaltyDeduction', label: 'Royalty Deduction', visible: true },
        { id: 'otherDeductionAmount', label: 'Other Deduction Amount', visible: true },
        { id: 'netPayableAmount', label: 'Net Payable Amount', visible: true },
        { id: 'pendingAmount', label: 'Pending Amount', visible: true },
        { id: 'courierDispatchDate', label: 'Courier Dispatch Date', visible: true },
...
export default BTSPaymentMaster;