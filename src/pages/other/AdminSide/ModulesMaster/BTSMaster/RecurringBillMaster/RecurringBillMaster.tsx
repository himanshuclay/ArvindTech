...
const RecurringBillMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'vendorNameAndCode', label: 'Vendor Name And Code', visible: true },
        ...
        { id: 'billAgainst', label: 'Bill Against', visible: true },
        { id: 'billStatus', label: 'Bill Status', visible: true },
        { id: 'source', label: 'Source', visible: true },
        { id: 'no', label: 'No', visible: true },
        { id: 'rate', label: 'Rate', visible: true },
        { id: 'date', label: 'Date', visible: true },
        { id: 'billStartMonth', label: 'Bill Start Month', visible: true },
        { id: 'billMonth', label: 'Bill Month', visible: true },
        { id: 'billNo', label: 'Bill No', visible: true },
        { id: 'billDate', label: 'Bill Date', visible: true },
        { id: 'billAmount', label: 'Bill Amount', visible: true },
        { id: 'billingRequiredGivenPeriod', label: 'Billing Required Given Period', visible: true },
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/RecurringBillMaster/GetRecurringBill${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.recurringBillMasters);
                setMesses(response.data.recurringBillMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/RecurringBillMaster/GetRecurringBill`, {
    ...
    useEffect(() => {
        ...
        fetchData('RecurringBillMaster/GetRecurringBill', setMessList, 'recurringBillMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>RecurringBill Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/RecurringBillMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add RecurringBill Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/RecurringBillMasterAddEdit/${item.id}`}>
...
export default RecurringBillMaster;