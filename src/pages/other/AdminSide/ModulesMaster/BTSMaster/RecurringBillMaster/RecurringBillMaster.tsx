...
const RecurringBillMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'vendorNameAndCode', label: 'vendorNameAndCode', visible: true },
        ...
        { id: 'billAgainst', label: 'billAgainst', visible: true },
        { id: 'billStatus', label: 'billStatus', visible: true },
        { id: 'source', label: 'source', visible: true },
        { id: 'no', label: 'no', visible: true },
        { id: 'rate', label: 'rate', visible: true },
        { id: 'date', label: 'date', visible: true },
        { id: 'billStartMonth', label: 'billStartMonth', visible: true },
        { id: 'billMonth', label: 'billMonth', visible: true },
        { id: 'billNo', label: 'billNo', visible: true },
        { id: 'billDate', label: 'billDate', visible: true },
        { id: 'billAmount', label: 'billAmount', visible: true },
        { id: 'billingRequiredGivenPeriod', label: 'billingRequiredGivenPeriod', visible: true },
