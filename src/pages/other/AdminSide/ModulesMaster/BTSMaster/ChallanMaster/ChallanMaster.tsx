...
const ChallanMaster = () => {
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/ChallanMaster/GetChallan`, {
    ...
    useEffect(() => {
        ...
        fetchData('ChallanMaster/GetChallan', setMessList, 'challanMasters');
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/ChallanMasterAddEdit/${item.id}`}>
