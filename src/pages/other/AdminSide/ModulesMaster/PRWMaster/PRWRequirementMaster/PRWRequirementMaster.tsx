...
{ id: 'activitiesToBePerformed', label: 'activitiesToBePerformed', visible: true},
...
{ id: 'finalStatus', label: 'finalStatus', visible: true},
...
{ id: 'updatedDate', label: 'updatedDate', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/PRWRequirementMaster/GetPRWRequirement/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data);
                setMesses(response.data.prwRequirementMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/PRWRequirementMaster/GetPRWRequirement`, {
    ...
    useEffect(() => {
        ...
        // fetchData('PRWRequirementMaster/GetPRWRequirement', setMessList, 'prwRequirementMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>PRWRequirement Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/PRWRequirementMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add PRWRequirement Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/PRWRequirementMasterAddEdit/${item.id}`}>
...
export default PRWRequirementMaster;