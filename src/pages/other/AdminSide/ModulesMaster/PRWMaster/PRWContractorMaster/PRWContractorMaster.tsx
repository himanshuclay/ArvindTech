...
{ id: 'leadDate', label: 'leadDate', visible: true},
{ id: 'prwLeadID', label: 'prwLeadID', visible: true},
{ id: 'sourceofLead', label: 'sourceofLead', visible: true},
{ id: 'searchTeamMember', label: 'searchTeamMember', visible: true},
{ id: 'location_State', label: 'location_State', visible: true},
{ id: 'location_District', label: 'location_District', visible: true},
{ id: 'fullNameofLead', label: 'fullNameofLead', visible: true},
{ id: 'fullNameofFirmoftheLead', label: 'fullNameofFirmoftheLead', visible: true},
{ id: 'leadMobileNumber', label: 'leadMobileNumber', visible: true},
{ id: 'leadAlternateContactNumber', label: 'leadAlternateContactNumber', visible: true},
{ id: 'prwCoordinator', label: 'prwCoordinator', visible: true},
{ id: 'callingConclusion', label: 'callingConclusion', visible: true},
{ id: 'reasonforRejection', label: 'reasonforRejection', visible: true},
{ id: 'callBackDate', label: 'callBackDate', visible: true},
{ id: 'contractorID', label: 'contractorID', visible: true},
{ id: 'undertaking_GSTR3B', label: 'undertaking_GSTR3B', visible: true},
{ id: 'monthlyturnoveramount_InLakhs', label: 'monthlyturnoveramount_InLakhs', visible: true},
{ id: 'gstNo', label: 'gstNo', visible: true},
{ id: 'uploadCopyofGSTReturn', label: 'uploadCopyofGSTReturn', visible: true},
{ id: 'nameofCompany_currentlyworkingwith', label: 'nameofCompany_currentlyworkingwith', visible: true},
{ id: 'contractorType', label: 'contractorType', visible: true},
{ id: 'pleaseconfirmifthePRWworksonSupply_MeasurementBasis', label: 'pleaseconfirmifthePRWworksonSupply_MeasurementBasis', visible: true},
{ id: 'typeofCapability', label: 'typeofCapability', visible: true},
{ id: 'originStateofMainContractor', label: 'originStateofMainContractor', visible: true},
{ id: 'isPRWregisteredunderEPF_ESI', label: 'isPRWregisteredunderEPF_ESI', visible: true},
{ id: 'ifaboveisNo_IsPRWwillingtoberegisteredunderEPF_ESI', label: 'ifaboveisNo_IsPRWwillingtoberegisteredunderEPF_ESI', visible: true},
{ id: 'statusUpdatedAt', label: 'statusUpdatedAt', visible: true},
...
{ id: 'updatedDate', label: 'updatedDate', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/PRWContractorMaster/GetPRWContractor/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data);
                setMesses(response.data.prwContractorMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/PRWContractorMaster/GetPRWContractor`, {
    ...
    useEffect(() => {
        ...
        // fetchData('PRWContractorMaster/GetPRWContractor', setMessList, 'prwContractorMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>PRWContractor Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/PRWContractorMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add PRWContractor Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/PRWContractorMasterAddEdit/${item.id}`}>
...
export default PRWContractorMaster;