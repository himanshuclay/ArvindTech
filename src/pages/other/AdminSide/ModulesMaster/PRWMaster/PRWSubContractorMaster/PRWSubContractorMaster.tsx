...
{ id: 'confirmationOfUpdationOfRequirementOfSubContractor', label: 'confirmationOfUpdationOfRequirementOfSubContractor', visible: true},
{ id: 'dateOfRequirement', label: 'dateOfRequirement', visible: true},
{ id: 'expectedDate', label: 'expectedDate', visible: true},
{ id: 'technicalDetails', label: 'technicalDetails', visible: true},
{ id: 'circulationOfRFPToAllShortlistedVendors', label: 'circulationOfRFPToAllShortlistedVendors', visible: true},
{ id: 'preparationOfComparativeStatement_ManagerSubcontract', label: 'preparationOfComparativeStatement_ManagerSubcontract', visible: true},
{ id: 'comparativeStatementPreparedBasedOn', label: 'comparativeStatementPreparedBasedOn', visible: true},
{ id: 'approvedVendorID', label: 'approvedVendorID', visible: true},
{ id: 'woNumber', label: 'woNumber', visible: true},
{ id: 'woRate', label: 'woRate', visible: true},
{ id: 'woDate', label: 'woDate', visible: true},
{ id: 'vendorID', label: 'vendorID', visible: true},
{ id: 'typeOfJobWork', label: 'typeOfJobWork', visible: true},
{ id: 'expectedDateOfDeployment', label: 'expectedDateOfDeployment', visible: true},
{ id: 'actualDateOfDeployment', label: 'actualDateOfDeployment', visible: true},
...
{ id: 'updatedDate', label: 'updatedDate', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/PRWSubContractorMaster/GetPRWSubContractor/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data);
                setMesses(response.data.prwSubContractorMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/PRWSubContractorMaster/GetPRWSubContractor`, {
    ...
    useEffect(() => {
        ...
        // fetchData('PRWSubContractorMaster/GetPRWSubContractor', setMessList, 'prwSubContractorMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>PRWSubContractor Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/PRWSubContractorMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add PRWSubContractor Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/PRWSubContractorMasterAddEdit/${item.id}`}>
...
export default PRWSubContractorMaster;