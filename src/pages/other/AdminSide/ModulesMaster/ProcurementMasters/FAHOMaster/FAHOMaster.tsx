...
const FAHOMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'asset_Group_Code', label: 'asset_Group_Code', visible: true},
        { id: 'assetCode', label: 'assetCode', visible: true},
        { id: 'assetType', label: 'assetType', visible: true},
        { id: 'assetName', label: 'assetName', visible: true},
        { id: 'systemName', label: 'systemName', visible: true},
        { id: 'model', label: 'model', visible: true},
        { id: 'workingStatus', label: 'workingStatus', visible: true},
        { id: 'empid', label: 'empid', visible: true},
        { id: 'userName', label: 'userName', visible: true},
        { id: 'department', label: 'department', visible: true},
        { id: 'location', label: 'location', visible: true},
        { id: 'qrCode', label: 'qrCode', visible: true},
        { id: 'serialNumber_IMEINumber', label: 'serialNumber_IMEINumber', visible: true},
        { id: 'processor', label: 'processor', visible: true},
        { id: 'ram', label: 'ram', visible: true},
        { id: 'harddisk', label: 'harddisk', visible: true},
        { id: 'warrantyExpired', label: 'warrantyExpired', visible: true},
        { id: 'microsoftIDWindows', label: 'microsoftIDWindows', visible: true},
        { id: 'operatingSystem', label: 'operatingSystem', visible: true},
        { id: 'operatingtype', label: 'operatingtype', visible: true},
        { id: 'microsoftIDOffice', label: 'microsoftIDOffice', visible: true},
        { id: 'msOffice', label: 'msOffice', visible: true},
        { id: 'antivirus', label: 'antivirus', visible: true},
        { id: 'antivirusExpiredDate', label: 'antivirusExpiredDate', visible: true},
        { id: 'antivirusKey', label: 'antivirusKey', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/FAHOMaster/GetFAHO/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data);
                setMesses(response.data.fahoMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/FAHOMaster/GetFAHO`, {
    ...
    useEffect(() => {
        ...
        // fetchData('FAHOMaster/GetFAHO', setMessList, 'fahoMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>FAHO Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/FAHOMasterAddEdit'>
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/FAHOMasterAddEdit/${item.id}`}>
