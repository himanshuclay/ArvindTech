...
//         { id: 'prNumber', label: 'prNumber', visible: true},
//         { id: 'entryDate', label: 'entryDate', visible: true},
//         { id: 'requirementDeliveryDate', label: 'requirementDeliveryDate', visible: true},
//         { id: 'projectRequirementDeliveryDate', label: 'projectRequirementDeliveryDate', visible: true},
//         { id: 'comparativeRequired', label: 'comparativeRequired', visible: true},
//         { id: 'selection', label: 'selection', visible: true},
//         { id: 'frcVendor', label: 'frcVendor', visible: true},
//         { id: 'vendorID1', label: 'vendorID1', visible: true},
//         { id: 'rate1', label: 'rate1', visible: true},
//         { id: 'unit1', label: 'unit1', visible: true},
//         { id: 'vendorID2', label: 'vendorID2', visible: true},
//         { id: 'rate2', label: 'rate2', visible: true},
//         { id: 'unit2', label: 'unit2', visible: true},
//         { id: 'vendorID3', label: 'vendorID3', visible: true},
//         { id: 'rate3', label: 'rate3', visible: true},
//         { id: 'unit3', label: 'unit3', visible: true},
...
//         const apiUrl = `${config.API_URL_APPLICATION1}/ComparativeMaster/GetComparative/${query}`;
//         console.log(apiUrl)
//         axios.get(apiUrl, { headers: { 'accept': '*/*' } })
//             .then((response) => {
//                 console.log("search response ", response.data.comparativeMasters);
//                 setMesses(response.data.comparativeMasters)
...
//         setLoading(true);
//         try {
//             const response = await axios.get(`${config.API_URL_APPLICATION1}/ComparativeMaster/GetComparative`, {
...
//         // fetchData('ComparativeMaster/GetComparative', setMessList, 'comparativeMasters');
...
//                 <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>Comparative Master</span></span>
...
//                         <Link to='/pages/ComparativeMasterAddEdit'>
//                             <Button variant="primary" className="me-2">
//                                 Add Comparative Master
//                             </Button>
//                         </Link>)}
...
//                                                     <td><Link to={`/pages/ComparativeMasterAddEdit/${item.id}`}>
...
// export default ComparativeMaster;