...
const MaterialRequisitionMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'materialGroup', label: 'materialGroup', visible: true },
        ...
        { id: 'prNo', label: 'prNo', visible: true },
        { id: 'uploadPR', label: 'uploadPR', visible: true },
        { id: 'acceptedQty', label: 'acceptedQty', visible: true },
        { id: 'prQty', label: 'prQty', visible: true },
        { id: 'rejectQty', label: 'rejectQty', visible: true },
        { id: 'otherJV', label: 'otherJV', visible: true },
        { id: 'stpR_Multiple', label: 'stpR_Multiple', visible: true },
        { id: 'reconcileQtyPR_Reject_OtherJV_STPR', label: 'reconcileQtyPR_Reject_OtherJV_STPR', visible: true },
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/MaterialRequisitionMaster/GetMaterialRequisition/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.materialRequisitionMasters);
                setMesses(response.data.materialRequisitionMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/MaterialRequisitionMaster/GetMaterialRequisition`, {
    ...
    useEffect(() => {
        ...
        // fetchData('MaterialRequisitionMaster/GetMaterialRequisition', setMessList, 'MaterialRequisitionMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>MaterialRequisition Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/MaterialRequisitionMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add MaterialRequisition Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/MaterialRequisitionMasterAddEdit/${item.id}`}>
...
export default MaterialRequisitionMaster;