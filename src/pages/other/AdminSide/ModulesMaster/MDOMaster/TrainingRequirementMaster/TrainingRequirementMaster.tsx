...
const TrainingRequirementMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'trainingRequirementDate', label: 'Training Requirement Date', visible: true },
        ...
        { id: 'hrUpdatedMobile', label: 'HR Updated Mobile', visible: true },
        { id: 'userUpdatedMobile', label: 'User Updated Mobile', visible: true },
        { id: 'trainingRequirementDescription', label: 'Training Requirement Description', visible: true },
        { id: 'trainingID', label: 'Training ID', visible: true },
        { id: 'opsTrainingStatus', label: 'Ops Training Status', visible: true },
        { id: 'dmeTrainingStatus', label: 'Dme Training Status', visible: true },
        { id: 'finalCompletionStatus', label: 'Final Completion Status', visible: true },
        { id: 'opsTrainingDatetime', label: 'Ops Training Datetime', visible: true },
        { id: 'dmeTrainingDatetime', label: 'Dme Training Datetime', visible: true },
        { id: 'finalTrainingDatetime', label: 'Final Training Datetime', visible: true },
        { id: 'trainingRemarks', label: 'Training Remarks', visible: true },
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/TrainingRequirementMaster/GetTrainingRequirement/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.trainingRequirementMasters);
                setMesses(response.data.trainingRequirementMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/TrainingRequirementMaster/GetTrainingRequirement`, {
    ...
    useEffect(() => {
        ...
        // fetchData('TrainingRequirementMaster/GetTrainingRequirement', setMessList, 'trainingRequirementMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>TrainingRequirement Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/TrainingRequirementMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add TrainingRequirement Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/TrainingRequirementMasterAddEdit/${item.id}`}>
...
export default TrainingRequirementMaster;