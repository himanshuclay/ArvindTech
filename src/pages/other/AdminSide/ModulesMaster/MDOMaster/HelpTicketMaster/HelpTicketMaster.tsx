...
const HelpTicketMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'helpTicketType', label: 'Help Ticket Type', visible: true},
        { id: 'projectID', label: 'Project ID', visible: true},
        { id: 'projectName', label: 'Project Name', visible: true},
        { id: 'helpTicketCategory', label: 'Help Ticket Category', visible: true},
        { id: 'module', label: 'Module', visible: true},
        { id: 'process', label: 'Process', visible: true},
        { id: 'helpTicketDescription', label: 'Help Ticket Description', visible: true},
        { id: 'problemSolver', label: 'Problem Solver', visible: true},
        { id: 'htRaisedBy', label: 'HT Raised By', visible: true},
        { id: 'htCreationDatetime', label: 'HT Creation Datetime', visible: true},
        { id: 'htid', label: 'HT id', visible: true},
        { id: 'taskID', label: 'TaskID', visible: true},
        { id: 'closureRemark', label: 'Closure Remark', visible: true},
        { id: 'agreedResolutionDate', label: 'Agreed Resolution Date', visible: true},
        { id: 'helpStatus', label: 'Help Status', visible: true},
        { id: 'taskStatus', label: 'Task Status', visible: true},
        { id: 'helpStatusUpdateDatetime', label: 'Help Status Update Datetime', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/HelpTicketMaster/GetHelpTicket/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.helpTicketMasters);
                setMesses(response.data.helpTicketMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/HelpTicketMaster/GetHelpTicket`, {
    ...
    useEffect(() => {
        ...
        // fetchData('HelpTicketMaster/GetHelpTicket', setMessList, 'helpTicketMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>HelpTicket Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/HelpTicketMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add HelpTicket Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/HelpTicketMasterAddEdit/${item.id}`}>
...
export default HelpTicketMaster;