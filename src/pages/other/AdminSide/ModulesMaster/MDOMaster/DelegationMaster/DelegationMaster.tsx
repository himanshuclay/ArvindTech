...
const DelegationMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'delegationPriority', label: 'Delegation Priority', visible: true },
        { id: 'delegationRemarks', label: 'Delegation Remarks', visible: true },
        { id: 'delegationDescription', label: 'Delegation Description', visible: true },
        { id: 'allocatedEmployee', label: 'Allocated Employee', visible: true },
        { id: 'delegationRaisedby', label: 'Delegation Raisedby', visible: true },
        { id: 'delegationCreationDatetime', label: 'Delegation Creation Datetime', visible: true },
        { id: 'delegationID', label: 'Delegation ID', visible: true },
        { id: 'taskID', label: 'Task ID', visible: true },
        { id: 'closureRemark', label: 'Closure Remark', visible: true },
        { id: 'assignedDate', label: 'Assigned Date', visible: true },
        { id: 'inputRequired', label: 'Input Required', visible: true },
        { id: 'delegationStatus', label: 'Delegation Status', visible: true },
        { id: 'taskStatus', label: 'Task Status', visible: true },
        { id: 'delegationStatusUpdateDatetime', label: 'Delegation Status Update Datetime', visible: true },
        { id: 'taskStatusUpdateDatetime', label: 'Task Status Update Datetime', visible: true },
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/DelegationMaster/GetDelegation/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.delegationMasters);
                setMesses(response.data.delegationMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/DelegationMaster/GetDelegation`, {
    ...
    useEffect(() => {
        ...
        // fetchData('DelegationMaster/GetDelegation', setMessList, 'delegationMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>Delegation Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/DelegationMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add Delegation Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/DelegationMasterAddEdit/${item.id}`}>
...
export default DelegationMaster;