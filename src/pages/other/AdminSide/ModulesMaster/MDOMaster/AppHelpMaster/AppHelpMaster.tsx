...
{ id: 'appHelpCategory', label: 'App Help Category', visible: true},
...
{ id: 'lineItemID', label: 'Line Item ID', visible: true},
{ id: 'appHelpContent', label: 'App Help Content', visible: true},
{ id: 'requestedInput', label: 'Requested Input', visible: true},
{ id: 'appHelpRaisedBy', label: 'App Help Raised By', visible: true},
{ id: 'appHelpCreationDatetime', label: 'App Help Creation Datetime', visible: true},
{ id: 'appHelpID', label: 'App Help ID', visible: true},
{ id: 'appHelpStatus', label: 'App Help Status', visible: true},
{ id: 'appHelpLevel', label: 'App Help Level', visible: true},
{ id: 'lastStatusUpdate', label: 'Last Status Update', visible: true},
{ id: 'closureRemarks', label: 'Closure Remarks', visible: true},
{ id: 'haEandResolutionDate', label: 'HAE and Resolution Date', visible: true},
{ id: 'historicalRemarks', label: 'Historical Remarks', visible: true},
{ id: 'trainingRequirement', label: 'Training Requirement', visible: true},
...
{ id: 'updatedDate', label: 'Updated Date', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/AppHelpMaster/GetAppHelp/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.appHelpMasters);
                setMesses(response.data.appHelpMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/AppHelpMaster/GetAppHelp`, {
    ...
    useEffect(() => {
        ...
        // fetchData('AppHelpMaster/GetAppHelp', setMessList, 'appHelpMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>AppHelp Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/AppHelpMasterAddEdit'>
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/AppHelpMasterAddEdit/${item.id}`}>
