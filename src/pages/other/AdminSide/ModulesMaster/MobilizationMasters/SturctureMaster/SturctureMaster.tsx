...
const SturctureMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'structureName', label: 'structureName', visible: true },
        { id: 'hydrologyRequired', label: 'hydrologyRequired', visible: true },
        { id: 'keyAreas', label: 'keyAreas', visible: true },
        { id: 'dangerWaterLevel', label: 'dangerWaterLevel', visible: true },
        { id: 'geoTechRequired', label: 'geoTechRequired', visible: true },
        { id: 'gadRequired', label: 'gadRequired', visible: true },
        { id: 'hydrologyStatus', label: 'hydrologyStatus', visible: true },
        { id: 'geotechStatus', label: 'geotechStatus', visible: true },
        { id: 'gadStatus', label: 'gadStatus', visible: true },
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/StructureMaster/GetStructure/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data);
                setMesses(response.data.structureMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/StructureMaster/GetStructure`, {
    ...
    useEffect(() => {
        ...
        // fetchData('SturctureMaster/GetSturcture', setMessList, 'structureMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>Sturcture Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/SturctureMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add Sturcture Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/SturctureMasterAddEdit/${item.id}`}>
...
export default SturctureMaster;