...
const PreliminaryWorkMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'uid', label: 'uid', visible: true },
        { id: 'preliminaryWork', label: 'preliminaryWork', visible: true },
        { id: 'tat', label: 'tat', visible: true },
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/PreliminaryWorkMaster/GetPreliminaryWork/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.preliminaryWorkMasters);
                setMesses(response.data.preliminaryWorkMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/PreliminaryWorkMaster/GetPreliminaryWork`, {
    ...
    useEffect(() => {
        ...
        // fetchData('PreliminaryWorkMaster/GetPreliminaryWork', setMessList, 'PreliminaryWorkMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>PreliminaryWork Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/PreliminaryWorkMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add PreliminaryWork Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/PreliminaryWorkMasterAddEdit/${item.id}`}>
...
export default PreliminaryWorkMaster;