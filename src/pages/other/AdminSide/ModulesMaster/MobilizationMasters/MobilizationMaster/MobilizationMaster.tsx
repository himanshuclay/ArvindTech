...
const MobilizationMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'tenderID', label: 'Tender ID', visible: true},
        { id: 'clientID', label: 'Client ID', visible: true},
        { id: 'client_JVName', label: 'Client JVName', visible: true},
        ...
        { id: 'contractualCompletionDate', label: 'Contractual Completion Date', visible: true},
        { id: 'projectCoordinatorEmpID', label: 'Project Coordinator EmpID', visible: true},
        { id: 'projectCoordinatorName', label: 'Project Coordinator Name', visible: true},
        { id: 'projectCoordinatorNumber', label: 'Project Coordinator Number', visible: true},
        { id: 'projectInchargeEmpID', label: 'Project Incharge EmpID', visible: true},
        { id: 'projectInchargeName', label: 'Project Incharge Name', visible: true},
        { id: 'projectInchargeNumber', label: 'Project Incharge Number', visible: true},
        { id: 'projectInchargeEmpID2', label: 'Project Incharge EmpID2', visible: true},
        { id: 'projectInchargeName2', label: 'Project Incharge Name2', visible: true},
        { id: 'projectInchargeNumber2', label: 'Project Incharge Number2', visible: true},
        { id: 'decisionToMobilize', label: 'Decision To Mobilize', visible: true},
        { id: 'expectedMobilizationDate', label: 'Expected Mobilization Date', visible: true},
        { id: 'expectedDateofKickofMeeting', label: 'Expected Dateof Kickof Meeting', visible: true},
        { id: 'keyMobTeamDeployedTeam1', label: 'Key Mob Team Deployed Team1', visible: true},
        { id: 'keyMobTeamDeployedTeam1Date', label: 'Key Mob Team Deployed Team1 Date', visible: true},
        { id: 'keyMobTeamDeployedTeam2', label: 'Key Mob Team Deployed Team2', visible: true},
        { id: 'keyMobTeamDeployedTeam2Date', label: 'Key Mob Team Deployed Team2 Date', visible: true},
        { id: 'constructionProgramSubmitted', label: 'Construction Program Submitted', visible: true},
        { id: 'constructionProgramSubmittedDate', label: 'Construction Program Submitted Date', visible: true},
        { id: 'layoutPlanFinalized', label: 'Layout Plan Finalized', visible: true},
        { id: 'campConstructionCompleted', label: 'Camp Construction Completed', visible: true},
        { id: 'electricalPlanFinalized', label: 'Electrical Plan Finalized', visible: true},
        { id: 'electricalPlanFinalizationDate', label: 'Electrical Plan Finalization Date', visible: true},
        { id: 'topographicReportShared', label: 'Topographic Report Shared', visible: true},
        { id: 'alignmentReportShared', label: 'Alignment Report Shared', visible: true},
        { id: 'hindranceListReviewed', label: 'Hindrance List Reviewed', visible: true},
        { id: 'bankAccountOpened', label: 'Bank Account Opened', visible: true},
        { id: 'guestHouseFinalized', label: 'Guest House Finalized', visible: true},
        { id: 'labCommissioned', label: 'Lab Commissioned', visible: true},
        { id: 'labCommissioningDate', label: 'Lab Commissioning Date', visible: true},
        { id: 'campLandFinalized', label: 'Camp Land Finalized', visible: true},
