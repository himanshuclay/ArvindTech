...
const MRequirementMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        { id: 'requirement', label: 'requirement', visible: true },
        { id: 'tat', label: 'tat', visible: true },
        { id: 'requisitionHandler', label: 'requisitionHandler', visible: true },
        { id: 'roleName', label: 'roleName', visible: true },
        { id: 'campLand', label: 'campLand', visible: true },
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/RequirementMaster/GetRequirement/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data.requirementMasters);
                setMesses(response.data.requirementMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/RequirementMaster/GetRequirement`, {
    ...
    useEffect(() => {
        ...
        // fetchData('RequirementMaster/GetRequirement', setMessList, 'requirementMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>Requirement Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/MRequirementMasterAddEdit'>
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/MRequirementMasterAddEdit/${item.id}`}>
...
export default MRequirementMaster;