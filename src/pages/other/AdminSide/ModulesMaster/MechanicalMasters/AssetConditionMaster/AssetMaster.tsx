...
const AssetConditionMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'assetCondition', label: 'Asset Condition', visible: true },
        { id: 'working_HSDorNonHSD', label: 'Working HSDorNonHSD', visible: true },
        { id: 'expectedAssetRelease_ResolutionDate', label: 'Expected Asset Release ResolutionDate', visible: true },
        { id: 'reasonofBreakdown', label: 'Reasonof Breakdown', visible: true },
        { id: 'warrantyStatus', label: 'Warranty Status', visible: true },
        { id: 'insuranceStatus', label: 'Insurance Status', visible: true },
        { id: 'timeofBreakdown', label: 'Timeof Breakdown', visible: true },
        { id: 'openingTankBalance', label: 'Opening TankBalance', visible: true },
        { id: 'hsdReceived', label: 'Hsd Received', visible: true },
        { id: 'closingTankBalance', label: 'Closing Tank Balance', visible: true },
        { id: 'openingReading', label: 'Opening Reading', visible: true },
        { id: 'closingReading', label: 'Closing Reading', visible: true },
        { id: 'workingHrs_RunningKM', label: 'Working Hrs RunningKM', visible: true },
        { id: 'cummulativeWorkingHrs_RunningKMs', label: 'Cummulative Working Hrs RunningKMs', visible: true },
        { id: 'assetisWorking', label: 'Assetis Working', visible: true },
