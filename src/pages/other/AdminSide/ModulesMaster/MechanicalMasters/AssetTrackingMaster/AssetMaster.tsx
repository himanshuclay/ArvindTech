...
const AssetTrackingMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'assetCode', label: 'Asset Code', visible: true },
        { id: 'dateOfDeployment', label: 'Date Of Deployment', visible: true },
        ...
        { id: 'assetMake', label: 'Asset Make', visible: true },
        { id: 'currentProject', label: 'Current Project', visible: true },
        { id: 'assetOwnership', label: 'Asset Ownership', visible: true },
        { id: 'currentStatusATProject', label: 'Current Status AT Project', visible: true },
        { id: 'transferredTo', label: 'Transferred To', visible: true },
        { id: 'forHSD', label: 'For HSD', visible: true },
        { id: 'imsSpareInventory', label: 'Ims Spare Inventory', visible: true },
        { id: 'assetServiceSchedule', label: 'Asset Service Schedule', visible: true },
        { id: 'rtoCompliance', label: 'Rto Compliance', visible: true },
        { id: 'preventiveMaintainance', label: 'Preventive Maintainance', visible: true },
        { id: 'preventiveMaintainanceFrequency', label: 'Preventive Maintainance Frequency', visible: true },
        { id: 'triggerValue', label: 'Trigger Value', visible: true },
        { id: 'nextPMDate', label: 'Next PM Date', visible: true },
        { id: 'operatorDriver', label: 'Operator Driver', visible: true },
        { id: 'engineNo', label: 'Engine No', visible: true },
        { id: 'chasisNo', label: 'Chasis No', visible: true },
        { id: 'dateOfRegistration', label: 'Date Of Registration', visible: true },
        { id: 'roadTaxValidTill', label: 'Road Tax Valid Till', visible: true },
        { id: 'nationalPermitValidTill', label: 'National Permit Valid Till', visible: true },
        { id: 'statePermitValidTill', label: 'State Permit Valid Till', visible: true },
        { id: 'nationalPermitGoodsValidTill', label: 'National Permit Goods Valid Till', visible: true },
        { id: 'fitnessValidTill', label: 'Fitness Valid Till', visible: true },
        { id: 'insuranceValidTill', label: 'Insurance Valid Till', visible: true },
        { id: 'pollutionValidTill', label: 'Pollution Valid Till', visible: true },
        { id: 'assetStatus', label: 'Asset Status', visible: true },
        { id: 'assetStatusUpdatedOn', label: 'Asset Status Updated On', visible: true },
        { id: 'updatedByTaskID', label: 'Updated By Task ID', visible: true },
        { id: 'modifiedBy', label: 'Modified By', visible: true },
        { id: 'editBy', label: 'Edit By', visible: true },
        { id: 'latestServicingDate', label: 'Latest Servicing Date', visible: true },
        { id: 'pmChecklist', label: 'Pm Checklist', visible: true },
