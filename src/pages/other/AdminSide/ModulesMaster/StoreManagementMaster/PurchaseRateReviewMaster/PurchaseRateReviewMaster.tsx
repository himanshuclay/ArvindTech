...
const PurchaseRateReviewMaster = () => {
...
{ id: 'maritalStatus', label: 'maritalStatus', visible: true},
...
{ id: 'updatedDate', label: 'updatedDate', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/PurchaseRateReviewMaster/GetPurchaseRateReview/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data);
                setMesses(response.data.purchaseRateReviewMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/PurchaseRateReviewMaster/GetPurchaseRateReview`, {
    ...
    useEffect(() => {
        ...
        // fetchData('PurchaseRateReviewMaster/GetPurchaseRateReview', setMessList, 'purchaseRateReviewMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>PurchaseRateReview Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/PurchaseRateReviewMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add PurchaseRateReview Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/PurchaseRateReviewMasterAddEdit/${item.id}`}>
...
export default PurchaseRateReviewMaster;