...
{ id: 'materialCategory', label: 'materialCategory', visible: true},
{ id: 'declaredQuantity', label: 'declaredQuantity', visible: true},
{ id: 'materialOwner', label: 'materialOwner', visible: true},
{ id: 'finalInspectedQuantity', label: 'finalInspectedQuantity', visible: true},
{ id: 'finalInspectionDateTime', label: 'finalInspectionDateTime', visible: true},
{ id: 'quantityPicked', label: 'quantityPicked', visible: true},
{ id: 'balanceQuantity', label: 'balanceQuantity', visible: true},
...
{ id: 'updatedDate', label: 'updatedDate', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/ScrapMaster/GetScrap/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data);
                setMesses(response.data.scrapMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/ScrapMaster/GetScrap`, {
    ...
    useEffect(() => {
        ...
        // fetchData('ScrapMaster/GetScrap', setMessList, 'scrapMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>Scrap Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/ScrapMasterAddEdit'>
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/ScrapMasterAddEdit/${item.id}`}>
