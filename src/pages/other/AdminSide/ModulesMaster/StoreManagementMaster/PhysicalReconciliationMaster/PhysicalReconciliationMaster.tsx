...
const PhysicalReconciliationMaster = () => {
...
{ id: 'materialType', label: 'materialType', visible: true},
{ id: 'materialTypeStatus', label: 'materialTypeStatus', visible: true},
...
{ id: 'updatedDate', label: 'updatedDate', visible: true},
    ...
    const handleSearch = (e?: React.FormEvent) => {
        ...
        const apiUrl = `${config.API_URL_APPLICATION1}/PhysicalReconciliationMaster/GetPhysicalReconciliation/${query}`;
        console.log(apiUrl)
        axios.get(apiUrl, { headers: { 'accept': '*/*' } })
            .then((response) => {
                console.log("search response ", response.data);
                setMesses(response.data.physicalReconciliationMasters)
    ...
    const fetchRoles = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${config.API_URL_APPLICATION1}/PhysicalReconciliationMaster/GetPhysicalReconciliation`, {
    ...
    useEffect(() => {
        ...
        // fetchData('PhysicalReconciliationMaster/GetPhysicalReconciliation', setMessList, 'physicalReconciliationMasters');
    ...
    return (
        <>
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2 text-dark fs-16"></i><span className='fw-bold text-dark fs-15'>PhysicalReconciliation Master</span></span>
                <div className="d-flex justify-content-end  ">
                    ...
                    {(role === 'Admin' || role === 'DME') && (
                        ...
                        <Link to='/pages/PhysicalReconciliationMasterAddEdit'>
                            <Button variant="primary" className="me-2">
                                Add PhysicalReconciliation Master
                            </Button>
                        </Link>)}
                                        ...
                                        messes.slice(0, 10).map((item, index) => (
                                            <tr key={item.id}>
                                                ...
                                                {(role === 'Admin' || role === 'DME') && (
                                                    ...
                                                    <td><Link to={`/pages/PhysicalReconciliationMasterAddEdit/${item.id}`}>
...
export default PhysicalReconciliationMaster;