...
const DrawingMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'structureID', label: 'Structure ID', visible: true },
        { id: 'structureType', label: 'Structure Type', visible: true },
        { id: 'pmsStartDate', label: 'PMS Start Date', visible: true },
        { id: 'typeofDesign', label: 'Type of Design', visible: true },
        { id: 'pierorSpanorChainageNo', label: 'Pieror Spanor Chainage No', visible: true },
        { id: 'drawingBoardCategory', label: 'Drawing Board Category', visible: true },
        { id: 'dtni', label: 'Dtni', visible: true },
        { id: 'drawingStatus', label: 'Drawing Status', visible: true },
        { id: 'expectedIssuanceDate', label: 'Expected Issuance Date', visible: true },
        { id: 'drawingTitle', label: 'Drawing Title', visible: true },
        { id: 'drawingNumber', label: 'Drawing Number', visible: true },
        { id: 'numberofSheet', label: 'Number of Sheet', visible: true },
        { id: 'revisionNumbe', label: 'Revision Numbe', visible: true },
        { id: 'subjectofEmail', label: 'Subject of Email', visible: true },
        { id: 'dateofEmail', label: 'Date of Email', visible: true },
        { id: 'gfcDate', label: 'GFC Date', visible: true },
        { id: 'piReview', label: 'PI Review', visible: true },
        { id: 'jvReview', label: 'JV Review', visible: true },
        { id: 'pC1Review', label: 'P C1 Review', visible: true },
        { id: 'pC2Review', label: 'P C2 Review', visible: true },
        { id: 'ddcReview', label: 'DDC Review', visible: true },
        { id: 'gfcSigned', label: 'GFC Signed', visible: true },
        { id: 'signedGFCShared', label: 'Signed GFC Shared', visible: true },
