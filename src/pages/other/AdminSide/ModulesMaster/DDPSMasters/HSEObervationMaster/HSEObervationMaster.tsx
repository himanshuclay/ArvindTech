...
const HSEObservationMaster = () => {
    ...
    const [columns, setColumns] = useState<Column[]>([
        ...
        { id: 'safetyPerson', label: 'Safety Person', visible: true },
        { id: 'assignDate', label: 'Assign Date', visible: true },
        { id: 'observationType', label: 'Observation Type', visible: true },
        { id: 'observation', label: 'Observation', visible: true },
        { id: 'site_ExactLocation', label: 'Site ExactLocation', visible: true },
        { id: 'responsibleContractor', label: 'Responsible Contractor', visible: true },
        { id: 'recommendation', label: 'Recommendation', visible: true },
        { id: 'targetDate', label: 'Target Date', visible: true },
        { id: 'allocatedLineIncharge', label: 'Allocated Line Incharge', visible: true },
        { id: 'severityRateLevel', label: 'Severity Rate Level', visible: true },
        { id: 'uploadPhotograph', label: 'Upload Photograph', visible: true },
        { id: 'approvedCorrectionPhotograph', label: 'Approved Correction Photograph', visible: true },
