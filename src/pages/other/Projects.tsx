...
const ProjectMaster: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            if (editingIndex !== null) {
                await axios.post('https://localhost:7074/api/ProjectMaster/UpdateProject', project);
            } else {
                await axios.post('https://localhost:7074/api/ProjectMaster/InsertProject', project);
            }
            fetchProjects();
            handleClose();
        } catch (error) {
    ...
    const convertToCSV = (data: Project[]) => {
        const csvRows = [
            ['Project Id','Project Name','Porject Id','Project Type','Management Contract','Project Incharge','Project Coordinator','Cocpletion Status','Name Of Work'],
            ...data.map(proj => [
                proj.id.toString(),
                proj.projectName,
                proj.projectID,
    ...
    return (
        <div className="container">
            <div className="d-flex bg-white p-2 my-2 justify-content-between align-items-center">
                <span><i className="ri-file-list-line me-2"></i><span className='fw-bold'>Projects List</span></span>
