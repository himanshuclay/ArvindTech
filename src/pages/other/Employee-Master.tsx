...
const EmployeeMaster: React.FC = () => {
    ...
    const fetchEmployees = async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://arvindo-api2.clay.in/api/EmployeeMaster/GetEmployee', {
                params: {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            if (editingIndex !== null) {
                await axios.post('https://arvindo-api2.clay.in/api/EmployeeMaster/UpdateEmployee', employee);
            } else {
                await axios.post('https://arvindo-api2.clay.in/api/EmployeeMaster/InsertEmployee', employee);
            }
            fetchEmployees();
            handleClose();
        } catch (error) {
